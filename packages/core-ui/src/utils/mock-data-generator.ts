...
export function generateMockDataFromMetadata(blockMetadata: BlockMetadata): Floor[] {
  ...
  // Generate floors from highest to lowest (floor 15 at top, floor 1 at bottom)
  for (let floorNum = blockMetadata.numFloors; floorNum >= 1; floorNum--) {
